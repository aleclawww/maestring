...
--
-- Supabase CLI applies migrations inside a transaction, which forbids
-- CONCURRENTLY. These indexes are created with a brief lock on small tables
-- — acceptable at this scale. All statements are idempotent
...
CREATE INDEX IF NOT EXISTS idx_ucs_next_review
...
CREATE INDEX IF NOT EXISTS idx_qa_session_question
...
CREATE INDEX IF NOT EXISTS idx_qa_concept
...
CREATE INDEX IF NOT EXISTS idx_ss_user_status
