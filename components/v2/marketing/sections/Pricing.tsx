...
const TIERS: Tier[] = [
  {
    ...
    price: '$119',
    cadence: 'one-time',
    description: 'Pay once. Keep access to one certification forever.',
    features: [
      'Lifetime access to one cert (e.g. SAA-C03)',
  ...
  },
  {
    ...
    price: '$29',
    cadence: 'per month',
    description: 'The full system across every cert. 7-day free trial.',
    features: [
